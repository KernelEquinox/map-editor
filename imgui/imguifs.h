...
#   ifdef _WIN32
/*
 * This line causes problems with recent versions of Windows:

 * #   include <windef.h> // On Windows we have MAX_PATH too
 *
 * Use <windows.h> to avoid those issues.
 */
#   include <windows.h>
/*
 * The issue above caused me like 2 hours of frustration.
 *
 * You're welcome. Thanks for nothing. >=T
 *
 *     - KernelEquinox
 */
#   endif //_WIN32
